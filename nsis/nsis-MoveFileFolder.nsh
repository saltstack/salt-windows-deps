...
#
# Instructions:
# Place this file in the `Include` directory in the NullSoft installation
#
# Usage:
#
...
#
# To move an individual directory:
...
!define MOVEFOLDER_JUMP ${__LINE__}
    ...
    # Delete empty subfolders moved - say the user just wanted to move *.apm
    # files, they now also have a load of empty dir's from dir structure duplication!
    Push $R2
